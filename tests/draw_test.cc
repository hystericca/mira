...
auto main() -> int {
    ...
    mira::GuiState about_frame_gui;
    mira::DrawList about_frame_draws;
    ...
    mira::GuiState canvas_context_gui;
    ...
    mira::DrawList canvas_context_draws;
    ...
    mira::GuiState sidebar_context_gui;
    ...
    mira::GuiState layer_context_gui;
